...
def collide_rock(stone_x,stone_y,rock_x,rock_y,stone1_x,rock1_x,player2_x,player2_y):
    global gamestart,timer_started,timer_started1,level,lost,score,score1
...
def checkwinner(player1_y,player2_y,score,score1,passed_timer,passed_timer1):
    global timer_started,timer_started1,level,lost,gamestart
    if score==70:
        timer_started=False
        timer_started1=False
        lost='player2'
...
while running:
    ...
    if gamestart:
        ...
        if level==1 or level==2:
            ...
            winner=checkwinner(player1_y,player2_y,score,score1,passed_time,passed_time1)
        ...
        if level==2 or level==3 or level==4 or level==5 or level==6:
            if score==score1: 
                ...
                text6=font_level.render("Level "+str(level-1),True,font_color2)
                root.blit(text6,(380,50)) 
